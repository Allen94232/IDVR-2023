...
namespace Oculus.Interaction
{
    public class RightHandTrigger : MonoBehaviour
    {
        ...
        void OnTriggerEnter(Collider other)
        {
            ...
            {
                GameObject.Find("WallGenerateManager").GetComponent<WallGenerateManager>().rightHandTriggerStatus = true;
            }
        }
        ...
        void OnTriggerExit(Collider other)
        {
            ...
            {
                GameObject.Find("WallGenerateManager").GetComponent<WallGenerateManager>().rightHandTriggerStatus = false;
            }
        }
