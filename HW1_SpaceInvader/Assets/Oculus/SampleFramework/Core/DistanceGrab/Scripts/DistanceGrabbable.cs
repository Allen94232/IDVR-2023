...
namespace OculusSampleFramework
{
    public class DistanceGrabbable : OVRGrabbable
    {
        ...
        protected override void Start()
        {
            ...
            m_gun = gameObject.GetComponentInChildren<GrabbableGun>();
        ...
        void RefreshGun()
        {
            if (m_gun)
            {
                if (isGrabbed) m_gun.SetState(GrabbableGun.State.Disabled);
                else if (!InRange) m_gun.SetState(GrabbableGun.State.Disabled);
                else
                    m_gun.SetState(Targeted
                        ? GrabbableGun.State.Targeted
                        : GrabbableGun.State.Enabled);
            }
